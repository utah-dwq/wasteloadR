...
whatNWISdata(siteNumbers="10171000", service="uv") # see also ?readNWISuv() to read high frequency values
gauge_data=readNWISdv(siteNumbers="10171000", parameterCd="00060") %>% rename(discharge_cfs=X_00060_00003, disch_code=X_00060_00003_cd)# Parameter code 00060 = discharge in cfs
```
