...
```{r, export-raw}
write_xlsx(c(gauge_info=gauge_info, gauge_data=gauge_data), path="raw_gauge_data.xlsx")
```
...
Example: subset to water year 2000 through present
...
To calculate seasonal or other custom nQy values, 
